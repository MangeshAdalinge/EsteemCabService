...
{
    public partial class ActivateDriver : System.Web.UI.Page
    {
        ...
        private void BindData()
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                ...
                if (deptId == null)
                {
                    lblRes.Text = "Not able to activate driver ..";
                }
                else
                {
        ...
        protected void DeleteCustomer(object sender, EventArgs e)
        {
            ...
            "CabId=@CabId;" +
             "select CabId,Status,Available from EcsCabDetails where Status ='Deactive', Available='n' " + "Order by CabId";
            cmd.Parameters.Add("@CabId", SqlDbType.VarChar).Value = lnkRemove.CommandArgument;
            GridView1.DataSource = GetData(cmd);
            GridView1.DataBind();
        }
        ...
        protected void UpdateCustomer(object sender, GridViewUpdateEventArgs e)
        {
            ...
            cmd.CommandText = "update EcsCabDetails set Status=@Status," + "Available=@Available where CabId=@CabId;" +

             "select CabId,Status,Available from EcsCabDetails where Status ='Deactive' and  Available='n' Order by CabId";
