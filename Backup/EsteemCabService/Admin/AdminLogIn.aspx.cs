...
namespace EsteemCabService
{
    public partial class AdminLogIn : System.Web.UI.Page
    {
        ...
        protected void ValidateUser(object sender, AuthenticateEventArgs e)
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("SP_EcsValidateAdmin"))
                {
                ...
                switch (userId)
                {
                    case -1:
                        ...
                        break;
                    case -2:
                        Login1.FailureText = "Not a valid Administraor";
                        break;
                    default:
                        FormsAuthentication.RedirectFromLoginPage(Login1.UserName, Login1.RememberMeSet);
                        Session["UserName"] = Login1.UserName;

                        string qry = "select distinct EmpId from dbo.EcsEmployee ec inner join dbo.EcsLogin el on ec.userId = el.UserId where el.UserName = '" + Login1.UserName + "'";
