...
{
    public partial class EcsMain : System.Web.UI.Page
    {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                ...
                switch (userId)
                {
                    ...
                    default:
                        ...
                        con.Close();
                        Response.Redirect("Customer/RideStatus.Aspx");
                        break;
                }
            }
        }
        ...
        {
            if (Convert.ToInt32(Session["SessionCount"]) > 0)
            {
                Session.Abandon();
                Session.Clear();
            }
            ...
            {
                Session["SessionCount"] = Convert.ToInt32("0");
