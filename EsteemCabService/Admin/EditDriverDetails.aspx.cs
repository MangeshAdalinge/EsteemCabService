...
namespace EsteemCabService.Driver
{
    public partial class EditDriverDetails : System.Web.UI.Page
    {
        ...
        private void BindData()
        {
            ...
            {
                con.Open();
                //SqlCommand cmd1 = new SqlCommand("SELECT DeptId FROM dbo.EcsEmployee ", con);
                ...
                //{
                    ...
                    using (SqlCommand cmd = new SqlCommand("SELECT * FROM dbo.EcsEmployee where DeptId = 2 Order by EmpId"))
                    {
        ...
        protected void DeleteCustomer(object sender, EventArgs e)
        {
            ...
            "EmpId=@EmpId;" +
             "select CabId,Status,Available from EcsEmployee where  " + "EmpId=@EmpId "+ "Order by EmpId";
